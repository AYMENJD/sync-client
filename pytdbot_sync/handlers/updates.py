    ...
    def on_updateAuthorizationState(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateAuthorizationState", func, filters, position)
    ...
    def on_updateMessageSendSucceeded(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateMessageSendSucceeded", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateMessageContentOpened(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateMessageContentOpened", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateMessageMentionRead(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateMessageMentionRead", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateChatIsTranslatable(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateChatIsTranslatable", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateChatIsMarkedAsUnread(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateChatIsMarkedAsUnread", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateChatOnlineMemberCount(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateChatOnlineMemberCount", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateActiveNotifications(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateActiveNotifications", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateBasicGroupFullInfo(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateBasicGroupFullInfo", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateSupergroupFullInfo(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateSupergroupFullInfo", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateServiceNotification(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateServiceNotification", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateFileGenerationStart(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateFileGenerationStart", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateFileGenerationStop(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateFileGenerationStop", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateFileAddedToDownloads(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateFileAddedToDownloads", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateGroupCallParticipant(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateGroupCallParticipant", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateNewCallSignalingData(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateNewCallSignalingData", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateUnreadMessageCount(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateUnreadMessageCount", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateInstalledStickerSets(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateInstalledStickerSets", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateTrendingStickerSets(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateTrendingStickerSets", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateSelectedBackground(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateSelectedBackground", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateLanguagePackStrings(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateLanguagePackStrings", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateAttachmentMenuBots(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateAttachmentMenuBots", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateActiveEmojiReactions(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateActiveEmojiReactions", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateDefaultReactionType(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateDefaultReactionType", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateNewChosenInlineResult(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateNewChosenInlineResult", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateNewPreCheckoutQuery(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateNewPreCheckoutQuery", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
    ...
    def on_updateNewChatJoinRequest(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                self.add_handler("updateNewChatJoinRequest", func, filters, position)
            elif isinstance(self, pytdbot_sync.filters.Filter):
                func._handler = Handler(
